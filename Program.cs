...
var utente1 = new Utente("Marco", "Grassi", "marcograssi@gmail.com", "qwerty", "3477418528");
var utente2 = new Utente("Paolo", "Rossi", "giusepperossi@gmail.com", "qwerty", "3477418528");
var utente3 = new Utente("Vincenzo", "Verdi", "giulioverdi@gmail.com", "qwerty", "3477418528");
...
var libro1 = new Libro("Harry Potter", 200, "fantascienza", "F666", new[] { "Harry", "Potter" }, 2000);
var libro2 = new Libro("La Storia Infinita", 300, "comico", "H1", new[] { "Bella", "Fantascenza" }, 5000);
var libro3 = new Libro("Alessandro Magnoe", 100, "storico", "S68", new[] { "Alessandro", "Magno" }, 2700);
libri.Add(libro1);
libri.Add(libro2);
libri.Add(libro3);
